<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="添加数量" prop="time">
    ...
    <el-table v-loading="loading" :data="cartList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="添加数量" align="center" prop="time" width="180">
...
<script>
import { listCart, getCart, delCart, addCart, updateCart } from "@/api/order/cart";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('order/cart/export', {
        ...this.queryParams
